...
// import  from './Fitness Events overview/FitnessEventsOverview'
import HealthActivityResponse from './HealthActivityResponse'
import HealthOverview from './HealthOverview'
import HealthEventsGraph from './HealthEventsGraph'
    ...
    useEffect(() => {
        ...
        const html = <Row>
            <Col className='col-lg-7'>
                <HealthOverview data={response.data.team_events_data} />
            </Col>
            <Col className='col-lg-4'>
                <HealthActivityResponse data={response.data.activity_respondent_data} />
                <HealthEventsGraph data={response.data.monthly_events_count_data} />
            </Col>
        </Row>
        setHtmlData(html)
