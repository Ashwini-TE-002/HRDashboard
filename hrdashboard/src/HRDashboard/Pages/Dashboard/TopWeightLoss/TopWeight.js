...
import LottieImg from '../../../../assets/HrDahsboard/grpp.png'
import { Container, Col, Row } from 'react-bootstrap'
import './TopWeight.moudle.css'
...
export default function TopWeight(topWeightLoss) {
    const topWeightLossData = topWeightLoss.topWeightLossData;
    ...
    const handleShow = () => {
        ...
        // Set Graph Data 
        setGraphData(response.data.top_weight_loss);

    }

    return (
        <>
            <div className='hpyindex'>
                <div className='hrDashboard-HeaddingTxt'>
                    <h6>Top Weight Loss</h6>
                </div>
                <div className='hindexBox'>
                    {/* <div>
                        <img src={LottieImg} className="VictorImage" alt="Lottieimg" />
                    </div> */}
                    <div className='happyest-image'>
                        <div style={{ position: 'absolute', width: '100%', top: '3rem', left: '2rem' }}>
                            <svg width="130" height="130" viewBox="0 0 2696 3518" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M312.151 2037.11L129.983 1728.2C114.053 1701.59 80.8985 1696.89 59.5875 1718.22C40.3399 1737.48 38.4403 1770.57 55.3273 1792.46L279.503 2068.32L312.151 2037.11Z" fill="#EFB68F" />
                                <path d="M257.949 1381.06C212.516 1442.71 150.779 1507.38 60.4301 1677.24C50.8601 1695.23 33.2817 1729.31 42.2834 1763.13C46.4616 1778.82 55.0946 1789.7 61.7511 1796.41C71.0241 1795.05 85.607 1791.55 101.434 1781.59C121.624 1768.88 133.687 1752.03 139.581 1742.52L385.226 1444.54C407.823 1414.98 404.536 1370.43 378.043 1347.21C353.393 1325.61 278.548 1353.12 257.949 1381.06Z" fill="#EFB68F" />
                                ...
                                <path d="M271.939 3426.02L288.314 3498.58H0V3496.46C5.06625e-05 3488.27 2.32023 3480.25 6.69191 3473.32C11.0636 3466.4 17.3078 3460.86 24.7008 3457.34L158.507 3403.95C163.32 3401.65 169.505 3401.75 173.171 3405.62C190.463 3423.87 209.455 3453.6 262.241 3421.35C266.071 3419.02 271.083 3421.61 271.939 3426.02V3426.02Z" fill="#0B4870" />
                                <path d="M288.355 3517.63H0.0419011V3498.6H288.355V3517.63Z" fill="#FFBE55" />
                                ...
                                <path d="M2695 807.755C2603.21 790.792 2462.84 773.766 2294.73 791.462C2052.89 816.916 1957.32 892.769 1751.3 900.398C1647.21 904.254 1495.56 891.407 1307.86 807.755V24.2797C1433.37 91.7203 1596.31 150.292 1781.01 134.598C1939.6 121.122 2010.61 61.6995 2194.66 24.2797C2319.13 -1.03039 2486.42 -14.4663 2695 24.2797L2695 807.755V807.755Z" fill="#FFBE55" />
                            </svg>
                        </div>
                    </div>
                    <div>
                        <div className='innerTxt flex'>
                            <h6>{topWeightLossData?.weight_loss}</h6>
                            <span>KG</span>
                        </div>
                        <div className='smallTxt'>
                            {
                                (topWeightLossData?.weight_percentage_status === "increased") ?
                                    <TiArrowSortedUp size={30} color={'#49DEB2'} />
                                    :
                                    <TiArrowSortedDown size={30} color={'#FA3B4E'} />
                            }

                            <span className='energy_score'>{topWeightLossData?.weight_loss_percentage}%</span>
                    ...
                    <div className='event-moudlePopupbody p-2'>
                        <ResponsiveContainer height={420}>
                            ...
                            >
                                ...
                                <Tooltip />
                                <Legend />
                                <Line type="monotone" dataKey="value" stroke="#00FFB4" activeDot={{ r: 8 }} />
                            </LineChart>
                        </ResponsiveContainer>
                    </div>
                </Modal.Body>
